Основная архитектурная задача разработчика: 
- разбить простое на части
- дать частям имена
- и связать части вместе
// ии не справляется с инженерным подхродом 
с разделением ответственности
декомпозицией абстракций
